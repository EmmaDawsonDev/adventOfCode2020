const bagRules = `mirrored silver bags contain 4 wavy gray bags.
...
function containsBag(arr, word) {
  ...
  if (arr.length <= 1) {
    ...
    for (let el of arr) {
      if (el.includes(word)) {
        newArr.push(el);
        currentWords.push(el.slice(0, el.indexOf(" bags")));
      }
    }
  }

  count = count + newArr.length - 1;
  //console.log(currentWords);
  //console.log(count);
  return currentWords;
}

for (let el of bagRulesArr) {
  if (el.startsWith("pale plum")) {
    console.log(el);
  }
}
// let currentWords = containsBag(bagRulesArr, "shiny gold");
// const arr = [];
// for (let i = 0; i < currentWords.length; i++) {
//   arr.push(containsBag(bagRulesArr, currentWords[i]));
// }
// //console.log(arr.flat(Infinity));

// const arrSet = new Set(arr.flat(Infinity));
// const newArrSet = [...arrSet];
// //console.log(newArrSet, newArrSet.length);

// const arr1 = [];
// for (let i = 0; i < newArrSet.length; i++) {
//   arr1.push(containsBag(bagRulesArr, newArrSet[i]));
// }
// const arr1Set = new Set(arr1.flat(Infinity));
// const newArr1 = [...arr1Set];
// //console.log(newArr1, newArr1.length);

// const arr2 = [];
// for (let i = 0; i < newArr1.length; i++) {
//   arr2.push(containsBag(bagRulesArr, newArr1[i]));
// }
// const arr2Set = new Set(arr2.flat(Infinity));
// const newArr2 = [...arr2Set];
// //console.log(newArr2, newArr2.length);

// const arr3 = [];
// for (let i = 0; i < newArr2.length; i++) {
//   arr3.push(containsBag(bagRulesArr, newArr2[i]));
// }
// const arr3Set = new Set(arr3.flat(Infinity));
// const newArr3 = [...arr3Set];
// //console.log(newArr3, newArr3.length);

// const arr4 = [];
// for (let i = 0; i < newArr3.length; i++) {
//   arr4.push(containsBag(bagRulesArr, newArr3[i]));
// }
// const arr4Set = new Set(arr4.flat(Infinity));
// const newArr4 = [...arr4Set];
// //console.log(newArr4, newArr4.length);

// const arr5 = [];
// for (let i = 0; i < newArr4.length; i++) {
//   arr5.push(containsBag(bagRulesArr, newArr4[i]));
// }
// const arr5Set = new Set(arr5.flat(Infinity));
// const newArr5 = [...arr5Set];
// //console.log(newArr5, newArr5.length);

// const arr6 = [];
// for (let i = 0; i < newArr5.length; i++) {
//   arr6.push(containsBag(bagRulesArr, newArr5[i]));
// }
// const arr6Set = new Set(arr6.flat(Infinity));
// const newArr6 = [...arr6Set];
// //console.log(newArr6, newArr6.length);

// const arr7 = [];
// for (let i = 0; i < newArr6.length; i++) {
//   arr7.push(containsBag(bagRulesArr, newArr6[i]));
// }
// const arr7Set = new Set(arr7.flat(Infinity));
// const newArr7 = [...arr7Set];
// //console.log(newArr7, newArr7.length);

// const arr8 = [];
// for (let i = 0; i < newArr7.length; i++) {
//   arr8.push(containsBag(bagRulesArr, newArr7[i]));
// }
// const arr8Set = new Set(arr8.flat(Infinity));
// const newArr8 = [...arr8Set];
// //console.log(newArr8, newArr8.length);

// const arr9 = [];
// for (let i = 0; i < newArr8.length; i++) {
//   arr9.push(containsBag(bagRulesArr, newArr8[i]));
// }
// const arr9Set = new Set(arr9.flat(Infinity));
// const newArr9 = [...arr9Set];
// //console.log(newArr9, newArr9.length);

// const arr10 = [];
// for (let i = 0; i < newArr9.length; i++) {
//   arr10.push(containsBag(bagRulesArr, newArr9[i]));
// }
// const arr10Set = new Set(arr10.flat(Infinity));
// const newArr10 = [...arr10Set];
// console.log(newArr10, newArr10.length);
